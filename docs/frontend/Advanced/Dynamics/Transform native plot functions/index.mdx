...
If this is running on the web, you might need to implement a download function in JavaScript, since there will be no files API available. However, here we will stick to the easiest way
