...
When a slide becomes visible or a fragment got revealed (see [Transitions and fragments](Slides.md#Transitions%20and%20fragments)) it fires an event, where all information is encoded. To enable this - use [SlideEventListener](../../Reference/Slides/SlideEventListener.md)

:::info
Put [SlideEventListener](../../Reference/Slides/SlideEventListener.md) anywhere on the slide to hook up WL Kernel to all events associated with it
:::

:::tip
Keep the dynamic variables scoped using [../../Reference/Tools/LeakyModule](../../Reference/Tools/LeakyModule) and use explicit event routing like in [routing](../Events%20system/routing.md). Later it will allow you to reuse your components for other slides much easier.
:::
...
Sure the state is not reservable in this case. You need to manage it by your own considering more events generated by [SlideEventListener](../../Reference/Slides/SlideEventListener.md).
