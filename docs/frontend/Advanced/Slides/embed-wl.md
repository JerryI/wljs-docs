...
Since it support WLX syntax as well, one can combine the copied text from the normal Wolfram Language cell into a [EditorView](frontend/Reference/GUI/EditorView.md) component
