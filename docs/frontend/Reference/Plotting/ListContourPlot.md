...
<Wl>{`ListContourPlot[Table[Sin[i + j^2], {i, 0, 3, 0.1}, {j, 0, 3, 0.1}], ImageSize->350]`}</Wl>
...
<Wl>{`ListContourPlot[Table[{x = RandomReal[{-2, 2}], y = RandomReal[{-2, 2}], Sin[x y]}, {1000}], ImageSize->350]`}</Wl>