...
<Wl>{`Insert[ArrayPlot[{{1, 0, 0, Pink}, {1, 1, 0, Pink}, {1, 0, 1, Red}}, ImageSize->350], PlotRange->{{0,4}, {0,3}}, 2]`}</Wl>
...
<Wl>{`Insert[Insert[ArrayPlot[Table[Sin[x y], {x, -40, 40}, {y, -40, 40}], ImageSize->350], PlotRange->{{0,80}, {0,80}}, 2], Controls->True, 2]`}</Wl>