...
An expression `displayView` is evaluated on [WLJS Interpreter](../../../../../interpreter/intro.md) in the browser with special property provided (see [core](../../Javascript%20API/core.md) and tutorial [WLJS Functions](frontend/Advanced/Frontend%20interpretation/WLJS%20Functions.md))
