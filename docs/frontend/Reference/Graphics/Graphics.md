...
Mostly all primitives are generated by a high-order functions like [Plot](../Plotting%20Functions/Plot.md), [ListLinePlot](../Plotting%20Functions/ListLinePlot.md), [ListVectorPlot](../Plotting%20Functions/ListVectorPlot.md), [BubbleChart](../Plotting%20Functions/BubbleChart.md) and etc
...
:::info
It can also be applied locally, see [TransitionType](TransitionType.md)
:::
...
:::info
It can also be applied locally, see [TransitionDuration](TransitionDuration.md)
:::
