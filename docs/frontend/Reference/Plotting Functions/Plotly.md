...
## Dev notes
This is a wrapper of `Plot`, that translates kinda in hacky way the result to [`ListLinePlotly`](../Plotly/ListLinePlotly.md). Which is __the only high-order plotting function__ that support dynamic updates out of the box.
