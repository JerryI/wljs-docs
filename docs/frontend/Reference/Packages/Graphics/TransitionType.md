...
---
acts as an option and a context modifier for [Graphics](Graphics.md) that tells the transition function for graphics primitives (coordinate changes, and etc) once one of dependencies has been updated
...
![](../../../../moves-ezgif.com-video-to-apng-converter.png)