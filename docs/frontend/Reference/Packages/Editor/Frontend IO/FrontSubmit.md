...
### Controlling ViewBox
A typical graphics figure is usually a [ViewBox](../Boxes/ViewBox.md). Here we mark its instance with a unique ID using [MetaMarker](../MetaMarker.md)
...
![](../../../../../Screenshot%202024-03-21%20at%2016.57.20.png)
