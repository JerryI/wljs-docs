...
__This is a default representation__ used in output cells. You can apply it to expressions before using in [EditorView](Editor/EditorView.md) and [InputEditor](Editor/InputEditor.md) and [CellPrint](Remote%20Cells/CellPrint.md).
