...
`RGBColor`, `DateObject` and [InterpretationBox](../../../Decorations/InterpretationBox.md) (together with [EditorView](../Editor/EditorView.md)) uses this structure to display a human-readable form of the content inside
...
:::warning
It must be evaluated in the context of an instance of `ViewBox`, use [MetaMarker](../MetaMarker.md) and [FrontSubmit](../Frontend%20IO/FrontSubmit.md) in order to apply this to a specific box
:::
...
:::tip
This method __is much faster__ than [InterpretationBox](../../../Decorations/InterpretationBox.md) or [Interpretation](../../../Decorations/Interpretation.md), since it does not spawn [EditorView](../Editor/EditorView.md) inside for displaying regular boxes.
:::
