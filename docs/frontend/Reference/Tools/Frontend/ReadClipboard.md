...
The content of the clipboard will pop up in a window called by [Alert](Frontend/Alert.md)

:::note
The data will not be transferred to Wolfram Kernel
:::
### Get the data to WL Kernel
You might use [TalkKernel](Frontend/TalkKernel.md) that allows to transfer data back to the WL Kernel
