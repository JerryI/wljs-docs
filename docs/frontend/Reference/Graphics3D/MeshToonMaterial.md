...
uses lighting model for [MeshMaterial](MeshMaterial.md) to emulate cell-shading effect
...
:::tip
An effect comes better when used together with [SpotLight](SpotLight.md) and minimal ambient lighting
:::
