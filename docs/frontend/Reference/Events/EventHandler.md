...
It comes handy, when you, for instance, [cloned](EventClone.md) events and need to purge the handlers before each reevaluation. There is an access to any output cell via [EvaluatingCell](../Tools/EvaluatingCell.md)
