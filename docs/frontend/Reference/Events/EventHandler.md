...
to wrap an [EventListener](../Graphics-D3/Internal/EventListener.md) or  [EventListener](../Graphics-ThreeJS/EventListener.md) over an arbitrary expression and attach listeners listed in `handlers` list if an `expr` supports it.
...
Not all of expressions support listeners, but `Graphics3D` and `Graphics` do, please see their [EventListener](../Graphics-ThreeJS/EventListener.md), [EventListener](../Graphics-D3/Internal/EventListener.md)
